...
# Optimiert (einen Schritt kürzer,
# funktioniert für ALLE Dinge, die nicht leer sind!
...
# Mit zwei Indizes (vorne und hinten)
# links = 0
# rechts = len(wort) - 1
...
# Mit nur einem index
# i = 0
# while i < len(wort) - 1 - i and wort[i] == wort[len(wort) - 1 - i]:
#     i = i + 1
# print(i >= len(wort) - 1 - i)
