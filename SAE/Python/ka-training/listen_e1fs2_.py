...
gruppe_a = ["Harami", "Knopki", "Lauster", "Class"]

# 2. Füge ein neues Element an der
# vierten Stelle dazu

gruppe_a.insert(3, "Härtel")

# 3. Bilde gruppe_b mit zwei bis drei
# Klassenmitgliedern.

gruppe_b = ["Kegreiß", "Arifi", "Conrad"]
...
# 9.
gruppe_c = ["Jan", "Tim", "David", "Jim", "Max", "Kai", "Eva", "Ute", "Tom"]
gruppe_c_original = gruppe_c.copy()

# Hole David von seinem jetzigen Platz und setze ihn vor Ute.

gruppe_c.insert(gruppe_c.index("Ute"), gruppe_c.pop(gruppe_c.index("David")))
